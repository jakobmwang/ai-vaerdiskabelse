...
<img alt="Hvordan vi ser det vs. hvordan systemet ser det (uden hjælp)" src="figures/hvordan_vi_ser_det.png" width="60%">

<!--
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{figures/hvordan_vi_ser_det.png}
\caption{Hvordan vi ser det vs. hvordan systemet ser det (uden hjælp)}
\end{figure}
-->
